...
import { agentColor } from "@/lib/tokens";
  ...
  return (
    <svg viewBox="0 0 16 16" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <g stroke="currentColor" strokeWidth={1.5} strokeLinecap="round">
        <path d="M8 8 8 3.1" />
        <path d="M8 8 3.6 12.2" />
        <path d="M8 8 12.4 12.2" />
      </g>
      <g fill="currentColor">
        <circle cx="8" cy="8" r="2.1" />
        <circle cx="8" cy="2.7" r="1.5" />
        <circle cx="3.3" cy="12.6" r="1.5" />
        <circle cx="12.7" cy="12.6" r="1.5" />
      </g>
    </svg>
  );
}
...
export function AgentLogo({ agent, className }: { agent: AgentName; className?: string }) {
  ...
  return (
    <span className="inline-flex items-center justify-center" style={{ color: agentColor(agent) }}>
